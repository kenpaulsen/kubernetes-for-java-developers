...
* [ba]sh:
	...
	jlink --module-path <your-linux-jmods> --output myjre --add-modules $(jdeps --print-module-deps target/app.jar),jdk.jdwp.agent,java.xml,jdk.unsupported,java.sql,java.naming,java.desktop,java.management,java.security.jgss,java.instrument
